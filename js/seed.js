...
const Seed = {
  build(){
    ...
    const db = {
      ...
      settings:{ orgName:'星瀚增长', fiscalYear:2026, quarterTarget: 8000000, owner:'林经理', dict:{}, aiModels:{ enabled:true, defaultId:'deepseek', providers:[ { id:'deepseek', name:'企业自配 DeepSeek V4-Flash', provider:'deepseek', apiKey:'', baseUrl:'https://api.deepseek.com/v1', model:'deepseek-v4-flash', enabled:true, isDefault:true }, { id:'qwen', name:'通义千问 Qwen-Max', provider:'qwen', apiKey:'', baseUrl:'https://dashscope.aliyuncs.com/compatible-mode/v1', model:'qwen-max', enabled:false, isDefault:false }, { id:'openai', name:'OpenAI GPT-4o', provider:'openai', apiKey:'', baseUrl:'https://api.openai.com/v1', model:'gpt-4o', enabled:false, isDefault:false } ] }, subscription:{ plan:'professional', planName:'专业版', startDate:'2026-07-01', endDate:'2027-06-30', autoRenew:true, status:'active', tokensTotal:1000000, tokensUsed:125430, prepaidAmount:5000, consumedAmount:627.15, pricePerToken:0.005, billingRecords:[ { date:'2026-07-15', type:'recharge', amount:3000, tokensAdded:600000, channel:'wechat', remark:'微信支付充值' }, { date:'2026-07-01', type:'recharge', amount:2000, tokensAdded:400000, channel:'alipay', remark:'支付宝充值' } ], consumptionRecords:[ { date:'2026-07-18', model:'deepseek-v4-flash', tokens:4520, cost:22.60, source:'AI助手对话' }, { date:'2026-07-17', model:'deepseek-v4-flash', tokens:12800, cost:64.00, source:'专家分析-行业评估' }, { date:'2026-07-15', model:'deepseek-v4-flash', tokens:3150, cost:15.75, source:'专家分析-客户洞察' }, { date:'2026-07-14', model:'qwen-max', tokens:8900, cost:44.50, source:'AI助手对话' } ] } }
    };
